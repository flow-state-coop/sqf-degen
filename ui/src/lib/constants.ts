...
export const DEGENX_ADDRESS = import.meta.env.VITE_DEGENX_ADDRESS;
...
export const STREAMING_QUADRATIC_FUNDING_ADDRESS = import.meta.env
  .VITE_STREAMING_QUADRATIC_FUNDING_ADDRESS;
export const GDA_CONTRACT_ADDRESS = import.meta.env.VITE_GDA_CONTRACT_ADDRESS;
export const GDA_POOL_ADDRESS = import.meta.env.VITE_GDA_POOL_ADDRESS;
